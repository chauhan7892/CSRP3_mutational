...
def main( ):
	...
	delta_delta = input_file[0] # file containing avg delta delta G info

	mutant_file = input_file[1] # file containing mutations

	phenotype = input_file[2]
	# call foldx_process
	output = foldx_process(delta_delta, mutant_file, phenotype)

	# output 
	output_txt = 'Mutation' + '\t' + 'Position' + '\t' + 'Delta_Delta_G' + '\t' + 'Feature' + '\t' + 'Phenotype' + '\n'
	output_txt += output
