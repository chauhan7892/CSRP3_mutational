...
class residue(object):
	def __init__( self, num, name, atom, x_coord = 0, y_coord = 0, z_coord = 0): # initialize the node
		self.rNum = num # residue position
		self.rName = name # residue name 
		self.rAtom = atom # atom name 
		self.rX = x_coord # residue x-coordinate
		self.rY = y_coord # residue y-coordinate
		self.rZ = z_coord # residue z-coordinate
